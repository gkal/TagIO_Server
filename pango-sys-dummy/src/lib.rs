// Dummy implementation of pango-sys
...
pub struct PangoLayout(pub *mut std::ffi::c_void);

#[derive(Debug, Copy, Clone)]
pub struct PangoContext(pub *mut std::ffi::c_void);

// Safe dummy implementation
unsafe impl Send for PangoLayout {}
unsafe impl Sync for PangoLayout {} 