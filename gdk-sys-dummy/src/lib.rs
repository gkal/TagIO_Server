// Dummy implementation of gdk-sys
...
pub struct GdkWindow(pub *mut std::ffi::c_void);

#[derive(Debug, Copy, Clone)]
pub struct GdkDisplay(pub *mut std::ffi::c_void);

// Safe dummy implementation
unsafe impl Send for GdkWindow {}
unsafe impl Sync for GdkWindow {} 